...
module Dphones.Object.Album_aggregate_fields exposing (..)
...
type alias CountOptionalArguments =
    { columns : OptionalArgument (List Dphones.Enum.Album_select_column.Album_select_column)
...
count :
    ...
    -> SelectionSet Int Dphones.Object.Album_aggregate_fields
count fillInOptionals____ =
    let
        ...
        optionalArgs____ =
            [ Argument.optional "columns" filledInOptionals____.columns (Encode.enum Dphones.Enum.Album_select_column.toString |> Encode.list), Argument.optional "distinct" filledInOptionals____.distinct Encode.bool ]
...
max :
    SelectionSet decodesTo Dphones.Object.Album_max_fields
    -> SelectionSet (Maybe decodesTo) Dphones.Object.Album_aggregate_fields
max object____ =
    Object.selectionForCompositeField "max" [] object____ (Basics.identity >> Decode.nullable)


min :
    SelectionSet decodesTo Dphones.Object.Album_min_fields
    -> SelectionSet (Maybe decodesTo) Dphones.Object.Album_aggregate_fields
min object____ =
