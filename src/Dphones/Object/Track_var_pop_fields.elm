...
module Dphones.Object.Track_var_pop_fields exposing (..)
...
index : SelectionSet (Maybe Float) Dphones.Object.Track_var_pop_fields
index =
    Object.selectionForField "(Maybe Float)" "index" [] (Decode.float |> Decode.nullable)


plays : SelectionSet (Maybe Float) Dphones.Object.Track_var_pop_fields
plays =
